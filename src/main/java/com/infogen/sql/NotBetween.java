...
public class NotBetween extends Operator {
	private static final long serialVersionUID = -4232996750996709020L;

	public NotBetween(String key, Number min, Number max) {
		super();
		this.key = key;
	...
	public NotBetween(String key, String min, String max) {
		super();
		this.key = key;
		this.min = min;
		this.max = max;
	...
	public NotBetween(String key, Number min, String max) {
		super();
		this.key = key;
		this.min = min.toString();
		this.max = max;
	...
	public NotBetween(String key, String min, Number max) {
		super();
		this.key = key;
		this.min = min;
		this.max = max.toString();
	...
	public String sql() {
		...
		string_builder.append(" NOT BETWEEN ");
